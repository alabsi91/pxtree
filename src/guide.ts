/** The agent reading guide. `pxtree guide`, the MCP `guide` tool and the skill file all print it verbatim. */
export const readingGuideText = `# pxtree: the rendered page as text
